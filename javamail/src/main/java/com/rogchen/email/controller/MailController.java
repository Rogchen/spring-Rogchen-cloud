...
public class MailController {
    ...
    public static void main(String[] args) throws Exception {
        ...
        props1.setProperty("mail.smtp.host", "smtp.163.com");
        session = Session.getInstance(props1);
        session.setDebug(true);
        Message msg1 = getMimeMessage(session,senderAddress0);
        transport = session.getTransport();
        transport.connect(senderAccount0, senderPassword0);
    ...
    public static MimeMessage getMimeMessage(Session session,String senderAddress) throws Exception {
        ...
        //设置邮件正文
        msg.setContent("简单的纯文本邮件！"+senderAddress+"test", "text/html;charset=UTF-8");
        //设置邮件的发送时间,默认立即发送
