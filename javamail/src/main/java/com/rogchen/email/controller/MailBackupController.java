...
public class MailBackupController {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Message msg1 = getMimeMessage(session1,senderAddress0);
        Transport transport1 = session1.getTransport();
        transport1.connect(senderAccount0, senderPassword0);
        transport1.sendMessage(msg1, msg1.getAllRecipients());
        transport1.close();
